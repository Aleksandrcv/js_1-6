...
// Задание 14 Подсчёт свойств 2.0
...
// Задание 20 Общая стоимость товара
...
// Задание 23 Изменение имени переменной
...
const bookShelf = {
  ...
  updateBook(oldName, newName) {
    // Change code below this line
	 const indexOldBooks = this.books.indexOf(oldName)
    console.log(indexOldBooks);
    this.books.splice(indexOldBooks, 1, newName)
    // Change code above this line
  },
};
...
// Задание 36 Лавка зелий «У старой жабы»
...
// Задание 38 Добавляем новое зелье
...
// Задание 41 Расширяем инвентарь
