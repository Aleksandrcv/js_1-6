...
// Задание 2 Задача: проверка пароля (ранний возврат)
...
// Задание 5 Доступ к элементам по индексу
...
// Задание 11 гравировка украшений
...
function calculateEngravingPrice(message, pricePerWord) {
  // Change code below this line
 let messa;
messa = (message.split(" ").length) * pricePerWord;
return  messa;
  // Changture code above this line
}
...
// В цикле for не должен использоваться break для выхода до завершения всех итераций цик
